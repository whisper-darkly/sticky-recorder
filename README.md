...
`STICKY_DRIVER`, `STICKY_RESOLUTION`, `STICKY_FRAMERATE`, `STICKY_SEGMENT_LENGTH`, `STICKY_COOKIES`, `STICKY_USER_AGENT`, `STICKY_LOG`, `STICKY_LOG_LEVEL`, `STICKY_OUTPUT_FORMAT`, `STICKY_RETRY_DELAY`, `STICKY_SEGMENT_TIMEOUT`, `STICKY_RECORDING_TIMEOUT`, `STICKY_CHECK_INTERVAL`
